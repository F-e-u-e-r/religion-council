...
- **議會成員層**:`../../agents/council-*.md` — 1 個主持人 + 宗教三層 + 一個世俗/哲學層:
  ...
  - **世俗/哲學層(非宗教)**:世俗人文主義(`council-secular-humanist`)、約翰·彌爾(`council-mill`)——標為哲學/倫理立場,非宗教傳統,不屬八家;見 `references/世俗人文與自由主義.md`。
...
**世俗/哲學層**(非宗教)範例:
> 「人生意義一定要靠宗教或來世嗎?請世俗人文主義與基督宗教、佛教對話。」
...
- 引用紀律是這套系統的核心價值:沒出處的具體引文須要求補出處;仍無法驗證時移除,或只以不構成支持的〔未驗證引用〕保留,不可改標〔詮釋〕。《古蘭經》一律標「釋義」。
