# Retrieval Benchmark v1 — Candidate: lexical-threshold (threshold=2)

## Status

**Experiment only.** This report evaluates a post-retrieval lexical confidence threshold (top\_score < 2 → no support) against the v0.12.2 lexical baseline. **No default behavior changed.** **No backend selected.**
...
- total: 0.0215s · avg query: 1.1971 ms · max query: 1.7992 ms
