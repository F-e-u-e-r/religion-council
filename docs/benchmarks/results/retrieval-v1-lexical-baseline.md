# Retrieval Benchmark v1 — Lexical Baseline

## Status

Baseline **measured**. **No backend selected.** This report is measurement only (see [retrieval-v1.md](../retrieval-v1.md)); running it does not adopt any index, BM25, hybrid, vector, or RAG backend.

## Retriever

- retriever_kind: `project-file`
- contract_version: `religion-council/retrieval/v1`
- corpus: C0 curated references — 56 records across 8 traditions (VERSION v0.12.1)
...
- total: 0.0254s · avg query: 1.4135 ms · max query: 2.0345 ms
